...
describe('Shape rendering', () => {
    ...
    test('Triangle renders correctly', () => {
        ...
        <svg width="300" height="200">
            ...
            <text x="95" y="145" fill="black" font-size="63" dominant-baseline="middle">XX</text>
        </svg>`.replace(/\s+/g, '');
    ...
    test('Circle renders correctly', () => {
        ...
        <svg width="300" height="200">
            ...
            <text x="60" y="110" fill="black" font-size="100" dominant-baseline="middle">XX</text>
        </svg>`.replace(/\s+/g, '');
    ...
    test('Square renders correctly', () => {
        ...
        <svg width="300" height="200">
            ...
            <text x="20" y="115" fill="black" font-size="150" dominant-baseline="middle">XX</text>
        </svg>`.replace(/\s+/g, '');
